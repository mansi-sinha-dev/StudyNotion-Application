...
//   }, [course])
  ...
  const onSubmit = async (data) => {
    ...
    if(editSectionName) {
      ...
      console.log("print data of course builder form", data);
    }

    // yha pe se na course m value update nhi ho pa rha hai db m section name add ho rha hai but ui usko fetch nhi kr paa rha hai
    ...
    console.log("courseContent data empty hi ku aa rha hai ", course);
