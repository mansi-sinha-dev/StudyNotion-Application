  ...
  return (
    <div >
        ...
        <section className=' bg-richblack-700'>
            <div className=' text-white w-11/12 mx-auto relative flex flex-col max-w-maxContent justify-between gap-10 text-center '>
        ...
        {/* section 3 */}
        <section>
            <div className=' flex flex-col w-11/12 max-w-maxContent mx-auto justify-between gap-10 text-richblack-500'>
                {/* founding Story */}
        ...
        <h2 className='text-center font-semibold mt-8  text-4xl'>
