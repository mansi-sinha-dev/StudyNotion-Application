...
export function login(email, password, navigate) {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("Printing the token", response.data.token);
      const userImage = response.data?.existUser?.image
        ...
        console.log( "Printing the token", response.data.existUser)
      dispatch(setUser({ ...response.data.existUser, image: userImage }))
      localStorage.setItem("token", JSON.stringify(response.data.token))
      localStorage.setItem("existUser", JSON.stringify(response.data.existUser))
